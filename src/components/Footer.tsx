        ...
        <div className='flex gap-12 lg:gap-28 justify-center py-7 md:pb-0 md:pt-2 w-full md:w-fit'>
          ...
          <div>
            ...
            <ul className='text-sm flex flex-col gap-1 text-slate-200/75 lg:pl-2'>
              ...
              <Link
                href={'/events'} className="relative w-fit block after:block  after:h-[2px] after:bg-white after:w-full 
              ...
              <Link
                href={'/team'} className="relative w-fit block after:block  after:h-[2px] after:bg-white after:w-full 
                after:scale-x-0 after:hover:scale-x-100 after:transition after:duration-300 after:origin-center hover:text-fuchsia-100 transition-all">
                Sponsors
              </Link>

              <Link
                href={'/registration'} className="relative w-fit block after:block  after:h-[2px] after:bg-white after:w-full 
                after:scale-x-0 after:hover:scale-x-100 after:transition after:duration-300 after:origin-center hover:text-fuchsia-100 transition-all">
                Teams
              </Link>
