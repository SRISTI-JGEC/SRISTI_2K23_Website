...
import { faInstagram, faLinkedin, faFacebookF, faDiscord } from '@fortawesome/free-brands-svg-icons'
          ...
          <div className="flex flex-col gap-y-4 mt-2 md:mt-5">
            ...
            <div>
              ...
              <a
                ...
                target="_blank"
                className="hover:text-blue-500 text-sm text-slate-100/75 hover:underline"
              >
                jgec.ac.in
              </a>
            </div>
        ...
        <div className="flex gap-12 lg:gap-28 justify-center py-7 md:pb-0 md:pt-2 w-full md:w-fit">
          <div>
            ...
            <ul className="text-sm flex flex-col gap-1 text-slate-200/75 lg:pl-2">
              <Link href={"/"} className="underlineStyle">
                About
              </Link>

              <Link href={"/sponsors"} className="underlineStyle">
                Sponsors
              </Link>

              <Link href={"/registration"} className="underlineStyle">
                Teams
              </Link>

              <Link href={"/events"} className="underlineStyle">
                SRISTI 2K22
              </Link>
            </ul>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-5 justify-center items-center md:justify-between w-full md:w-fit">
          ...
          <div className="flex lg:flex-col gap-2 md:mt-2 lg:pr-3">
            <motion.a
              ...
              target="_blank"
              href="https://www.instagram.com/sristi2k23_jgec/"
            >
              <FontAwesomeIcon
                icon={faInstagram}
            ...
            <motion.a
              ...
              className="group p-3 flex justify-center items-center rounded-full hover:bg-slate-100/10 transition-all duration-75"
              target="_blank"
              href="https://discord.com/channels/1155780536564973589/1155783220055527435"
            >
              <FontAwesomeIcon
                icon={faDiscord}
