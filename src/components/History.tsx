...
const History = () => {
  return (
    <div className="min-h-[80vh] w-full flex flex-col justify-start font-griffy">
      <div className="p-[10px] flex flex-col items-center px-8 justify-start">
        <div className="font-griffy text-[2.7rem] text-white tracking-wider max-sm:text-[2rem] font-semibold">
          Sristi and JGEC
        </div>
        <Image
          src={stick}
          alt="stick"
          className="w-[30rem] my-[-10px]"
          draggable={false}
        />
      </div>
      <div className="w-full flex justify-end items-center min-h-[20%] mt-5 flex-col">
        ...
        <div className="min-h-full w-auto rounded-md my-4 flex flex-col justify-start items-start p-10 text-white text-2xl max-sm:text-lg max-sm:p-5 bg-[rgba(0,0,0,0.5)]  backdrop-blur-md">
