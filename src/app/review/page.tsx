        ...
        <div className="w-full h-screen flex flex-col z-10 justify-around items-center text-white ">
          ...
          <div className="w-[90%] lg:w-2/5 border border-text-gray-300 bg-black/75 backdrop-blur-sm p-6 rounded-lg text-gray-100">
            ...
            >
              ...
              <div className="flex justify-between">
                <button className="bg-blue-700 w-[45%] p-2 rounded-md hover:scale-95 hover:bg-blue-500 transition-all duration-100">
                  Submit
                </button>
                <button
                  type="reset"
                  className="bg-red-700 w-[45%] p-2 rounded-md hover:scale-95 hover:bg-red-500 transition-all duration-100"
                >
                  Reset
                </button>
              </div>
