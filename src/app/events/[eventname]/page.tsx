    ...
    <>
      ...
      {!openTab ? (
        ...
        <div className="w-full h-screen absolute top-0 left-0 ">
          <div
            className=" fixed right-4 sm:right-[5rem] top-[6rem] cursor-pointer z-50 rounded  px-4 py-2 bg-red-500 text-white"
            onClick={(e) => setOpenTab(false)}
          >
            closed
          </div>
          {eventData ? <EventRegistration props={eventData} /> : <></>}
        </div>
      )}
    </>
  );
